...
import { BookOpen, CreditCard, GraduationCap, Home, LayoutDashboard, LogOut, Menu, User } from "lucide-react"
        ...
        <div className="min-h-screen bg-slate-50 flex flex-col md:flex-row">
            ...
            <aside className="hidden md:flex w-64 flex-col bg-white border-r border-gray-200 min-h-screen fixed left-0 top-0 z-20">
                <div className="p-6 h-20 flex items-center border-b border-gray-100">
                    <span className="text-2xl font-serif font-bold text-primary">School ESP</span>
                </div>
                ...
                <div className="flex items-center gap-2">
                    <Sheet>
                        ...
                        <SheetContent side="left" className="p-0 w-72">
                            <div className="p-6 h-20 flex items-center border-b border-gray-100">
                                <SheetTitle className="text-2xl font-serif font-bold text-primary">School ESP</SheetTitle>
                            </div>
                            <nav className="flex-1 p-4 space-y-1">
                                {navItems.map((item) => {
                                    const isActive = pathname === item.href
                    ...
                    <span className="text-xl font-bold font-serif text-primary">School ESP</span>
                </div>
                <Link href="/auth">
